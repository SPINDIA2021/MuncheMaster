...
public class CurrentOrderActivity extends AppCompatActivity{
    ...
    private TextView mTimeFormatText, tvDistance,tvAddress;
    private String resUid,uid,resPhoneNum,resName,orderid;
    ...
    public void changestatusbarcolor() {
        ...
        tvAddress=findViewById(R.id.currentOrderResLoc);
    }
    ...
    private void fetchInfo() {
        ...
        db.collection(RES_LIST).document(resUid).get().addOnCompleteListener(task -> {
            ...
            if (task.isSuccessful()){
                ...
                tvAddress.setText((String)documentSnapshot.get("restaurant_address"));
    ...
    private void init(double mResLongitude, double mResLatitude,double mUserLongitude, double mUserLatitude, String resName, String resPhoneNum) {
        ...
        ImageView mOrderStatus = findViewById(R.id.statusBtn);
    ...
    BottomSheetDialog dialogBox;
    ImageView imgPlaced,imgPrepared,imgPreparedRoad,imgOntheWay,imgOnTheWayRoad,imgDelivered,imgDeliveredRoad;
    private void showStatusBottomDailog() {

        dialogBox = new BottomSheetDialog(this,R.style.AppBottomSheetDialogTheme);
        dialogBox.setContentView(R.layout.bottomdailog_ordestatus);

        imgPlaced=dialogBox.findViewById(R.id.img_orderplaced);
        imgPrepared=dialogBox.findViewById(R.id.img_orderprepare);
        imgPreparedRoad=dialogBox.findViewById(R.id.img_orderprepareroad);
        imgOntheWay=dialogBox.findViewById(R.id.img_orderontheway);
        imgOnTheWayRoad=dialogBox.findViewById(R.id.img_orderonthewayroad);
        imgDelivered=dialogBox.findViewById(R.id.img_orderdelvered);
        imgDeliveredRoad=dialogBox.findViewById(R.id.img_orderdelveredroad);
...
// Make a toast which displays the route's distance
              //  Toast.makeText(getApplicationContext(), "The distance is: " +  currentRoute.distance(), Toast.LENGTH_SHORT).show();
                ...
                tvDistance.setText("Distance: "+df.format(currentRoute.distance()/1000)+ "KM");
                if (mapboxMap != null) {
