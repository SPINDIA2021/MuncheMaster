...
public class ChangeLocationActivity extends AppCompatActivity implements
    ...
    private Button btnAddAddress,btnSelectAddress;
    ...
    private void init() {
        ...
        btnAddAddress = findViewById(R.id.addLocationBtn);
        btnSelectAddress = findViewById(R.id.selectLocationBtn);

        btnAddAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ChangeLocationActivity.this,AddAddressActivity.class));
            }
        });
        ...
        btnSelectAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ChangeLocationActivity.this,SelectAddressFragment.class));
            }
        });
    }
