...
public class MyProfileFragment extends Fragment implements View.OnClickListener {
    ...
    private View view;
    private TextView mLogOutText,mUserProfileName,mUserProfileNum,mUserProfileAddress,mCurrentOrderText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     //   mCurrentOrderText.setOnClickListener(this);
    ...
    private void init() {
        ...
        //mCurrentOrderText=view.findViewById(R.id.currentOrderText);
